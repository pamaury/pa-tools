...
#define NEMC_SMCR(1)	(NEMC_BASE + 0x14)  /* Static Memory Control Register 1 */
#define NEMC_SMCR(2)	(NEMC_BASE + 0x18)
#define NEMC_SMCR(3)	(NEMC_BASE + 0x1c)
#define NEMC_SMCR(4)	(NEMC_BASE + 0x20)
#define NEMC_SMCR(5)	(NEMC_BASE + 0x24)
#define NEMC_SMCR(6)	(NEMC_BASE + 0x28)
#define NEMC_SACR(1)	(NEMC_BASE + 0x34)
#define NEMC_SACR(2)	(NEMC_BASE + 0x38)
#define NEMC_SACR(3)	(NEMC_BASE + 0x3c)
#define NEMC_SACR(4)	(NEMC_BASE + 0x40)
#define NEMC_SACR(5)	(NEMC_BASE + 0x44)
#define NEMC_SACR(6)	(NEMC_BASE + 0x48)

#define REG_NEMC_NFCSR	REG32(NEMC_NFCSR)
#define REG_NEMC_SMCR(n)	REG32(NEMC_SMCR(n))
...
#define REG_NEMC_SACR(n)	REG32(NEMC_SACR(n))
