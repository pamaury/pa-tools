...
#define TSSI_NUM       (TSSI_BASE + 0x18)
#define TSSI_DTR       (TSSI_BASE + 0x1c)
/* n is the PID (0-15) */
...
#define TSSI_DDA	(TSSI_BASE + 0x60)
#define TSSI_DTA	(TSSI_BASE + 0x64)
#define TSSI_DID	(TSSI_BASE + 0x68)
#define TSSI_DCMD	(TSSI_BASE + 0x6c)
#define TSSI_DST	(TSSI_BASE + 0x70)
#define TSSI_TC		(TSSI_BASE + 0x74)
...
#define TSSI_CFG_TRANS_MD__0	(0 << TSSI_CFG_TRANS_MD_BIT)
#define TSSI_CFG_TRANS_MD__1	(1 << TSSI_CFG_TRANS_MD_BIT)
#define TSSI_CFG_TRANS_MD__2	(2 << TSSI_CFG_TRANS_MD_BIT)
...
#define TSSI_CFG_USE_0		(1 << 6)      /* serial mode data pin select: 0 for TSDI7, 1 for TSDI0 */
