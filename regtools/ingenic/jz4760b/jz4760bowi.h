...
#define OWI_OWICFG_MODE	BIT7
#define OWI_OWICFG_RDDATA	BIT6
#define OWI_OWICFG_WRDATA	BIT5
#define OWI_OWICFG_RDST	BIT4
#define OWI_OWICFG_WR1RD	BIT3
#define OWI_OWICFG_WR0	BIT2
#define OWI_OWICFG_RST	BIT1
...
#define OWI_OWISTS_BYTE_RDY		BIT2
#define OWI_OWISTS_BIT_RDY		BIT1
#define OWI_OWISTS_PST_RDY		BIT0

/* OWI clock divide register(OWIDIV) */
#define OWI_OWIDIV_CLKDIV_LSB	0
#define OWI_OWIDIV_CLKDIV_MASK	BITS_H2L(5, OWI_OWIDIV_CLKDIV_LSB)
