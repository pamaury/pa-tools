...
#define AIC_SPENA_OFFSET	(0x80)
#define AIC_SPCTRL_OFFSET	(0x84)
#define AIC_SPSTATE_OFFSET	(0x88)
#define AIC_SPCFG1_OFFSET	(0x8c)
#define AIC_SPCFG2_OFFSET	(0x90)
#define AIC_SPFIFO_OFFSET	(0x94)

#define AIC_RGADW_OFFSET	(0xa4)
#define AIC_RGDATA_OFFSET	(0xa8)
...
#define AIC_SPENA	(AIC_BASE + AIC_SPENA_OFFSET)
#define AIC_SPCTRL	(AIC_BASE + AIC_SPCTRL_OFFSET)
#define AIC_SPSTATE	(AIC_BASE + AIC_SPSTATE_OFFSET)
#define AIC_SPCFG1	(AIC_BASE + AIC_SPCFG1_OFFSET)
#define AIC_SPCFG2	(AIC_BASE + AIC_SPCFG2_OFFSET)
#define AIC_SPFIFO	(AIC_BASE + AIC_SPFIFO_OFFSET)

#define AIC_RGADW	(AIC_BASE + AIC_RGADW_OFFSET)
#define AIC_RGDATA	(AIC_BASE + AIC_RGDATA_OFFSET)
...
/* AIC controller configuration register(FR) */
...
/* AIC controller common control register(CR) */
...
/* AIC controller FIFO status register (SR) */
...
#define AIC_SPENA_SPEN		BIT0

/* SPDIF control register (SPCTRL) */
#define AIC_SPCTRL_DMAEN        BIT15
#define AIC_SPCTRL_DTYPE        BIT14
#define AIC_SPCTRL_SIGN         BIT13
#define AIC_SPCTRL_INVALID      BIT12
#define AIC_SPCTRL_RST          BIT11
#define AIC_SPCTRL_SPDIFI2S     BIT10
#define AIC_SPCTRL_MTRIG        BIT1
#define AIC_SPCTRL_MFFUR        BIT0

/* SPDIF state register (SPSTATE) */
#define AIC_SPSTATE_BUSY		BIT7
#define AIC_SPSTATE_FTRIG	BIT1
#define AIC_SPSTATE_FUR		BIT0

#define AIC_SPSTATE_FLVL_LSB	8
#define AIC_SPSTATE_FLVL_MASK	BITS_H2L(14, AIC_SPSTATE_FLVL_LSB)

/* SPDIF configure 1 register (SPCFG1) */
#define AIC_SPCFG1_INITLVL	BIT17
#define AIC_SPCFG1_ZROVLD	BIT16

#define AIC_SPCFG1_TRIG_LSB	12
#define AIC_SPCFG1_TRIG_MASK	BITS_H2L(13, AIC_SPCFG1_TRIG_LSB)
#define AIC_SPCFG1_TRIG(n)	(((n) > 16 ? 3 : (n)/8) << AIC_SPCFG1_TRIG_LSB)	/* n = 4, 8, 16, 32 */

#define AIC_SPCFG1_SRCNUM_LSB	8
#define AIC_SPCFG1_SRCNUM_MASK	BITS_H2L(11, AIC_SPCFG1_SRCNUM_LSB)

#define AIC_SPCFG1_CH1NUM_LSB	4
#define AIC_SPCFG1_CH1NUM_MASK	BITS_H2L(7, AIC_SPCFG1_CH1NUM_LSB)

#define AIC_SPCFG1_CH2NUM_LSB	0
#define AIC_SPCFG1_CH2NUM_MASK	BITS_H2L(3, AIC_SPCFG1_CH2NUM_LSB)

/* SPDIF configure 2 register (SPCFG2) */
#define AIC_SPCFG2_MAXWL	BIT18
#define AIC_SPCFG2_PRE		BIT3
#define AIC_SPCFG2_COPYN	BIT2
#define AIC_SPCFG2_AUDION	BIT1
#define AIC_SPCFG2_CONPRO	BIT0

#define AIC_SPCFG2_FS_LSB	26
#define AIC_SPCFG2_FS_MASK	BITS_H2L(29, AIC_SPCFG2_FS_LSB)

#define AIC_SPCFG2_ORGFRQ_LSB	22
#define AIC_SPCFG2_ORGFRQ_MASK	BITS_H2L(25, AIC_SPCFG2_ORGFRQ_LSB)

#define AIC_SPCFG2_SAMWL_LSB	19
#define AIC_SPCFG2_SAMWL_MASK	BITS_H2L(21, AIC_SPCFG2_SAMWL_LSB)

#define AIC_SPCFG2_CLKACU_LSB	16
#define AIC_SPCFG2_CLKACU_MASK	BITS_H2L(17, AIC_SPCFG2_CLKACU_LSB)

#define AIC_SPCFG2_CATCODE_LSB	8
#define AIC_SPCFG2_CATCODE_MASK	BITS_H2L(15, AIC_SPCFG2_CATCODE_LSB)

#define AIC_SPCFG2_CHMD_LSB	6
#define AIC_SPCFG2_CHMD_MASK	BITS_H2L(7, AIC_SPCFG2_CHMD_LSB)

/* ICDC internal register access control register(RGADW) */
#define AIC_RGADW_RGWR		BIT16

#define AIC_RGADW_RGADDR_LSB	8
#define	AIC_RGADW_RGADDR_MASK	BITS_H2L(14, AIC_RGADW_RGADDR_LSB)

#define AIC_RGADW_RGDIN_LSB	0
#define	AIC_RGADW_RGDIN_MASK	BITS_H2L(7, AIC_RGADW_RGDIN_LSB)

/* ICDC internal register data output register (RGDATA)*/
#define AIC_RGDATA_IRQ		BIT8

#define AIC_RGDATA_RGDOUT_LSB	0
#define AIC_RGDATA_RGDOUT_MASK	BITS_H2L(7, AIC_RGDATA_RGDOUT_LSB)
...
#define REG_AIC_SPENA		REG32(AIC_SPENA)
#define REG_AIC_SPCTRL		REG32(AIC_SPCTRL)
#define REG_AIC_SPSTATE		REG32(AIC_SPSTATE)
#define REG_AIC_SPCFG1		REG32(AIC_SPCFG1)
#define REG_AIC_SPCFG2		REG32(AIC_SPCFG2)
#define REG_AIC_SPFIFO		REG32(AIC_SPFIFO)

#define	REG_AIC_RGADW		REG32(AIC_RGADW)
#define	REG_AIC_RGDATA		REG32(AIC_RGDATA)
