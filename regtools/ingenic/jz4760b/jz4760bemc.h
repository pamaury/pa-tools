...
/* n is index (0-6) */
#define EMC_SMCR(n)	(EMC_BASE + 0x10 + (n)*4)  /* Static Memory Control Register  */
...
/* n is bank (0-4) */
#define EMC_SACR(n)	(EMC_BASE + 0x30 + (n)*4)  /* Static Memory Bank Addr Config Reg */
...
#define REG_EMC_SACR(n)	REG32(EMC_SACR(n))
...
#define REG_EMC_DMAR(n)	REG32(EMC_DMAR(n))
...
#define EMC_BCR_BSR_BIT 2
#define EMC_BCR_BSR_MASK          (1 << EMC_BCR_BSR_BIT)  /* Nand and SDRAM Bus Share Select: 0, share; 1, unshare */
  #define EMC_BCR_BSR_SHARE       (0 << EMC_BCR_BSR_BIT)
  #define EMC_BCR_BSR_UNSHARE     (1 << EMC_BCR_BSR_BIT)
