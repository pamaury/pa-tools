...
#define WDT_WCER_TCEN	BIT0

/* Watchdog control register(WCSR) */
#define WDT_WCSR_PRESCALE_BIT	3
#define WDT_WCSR_PRESCALE_MASK	BITS_H2L(5, WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_1		(0x0 << WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_4		(0x1 << WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_16		(0x2 << WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_64		(0x3 << WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_256	(0x4 << WDT_WCSR_PRESCALE_BIT)
#define WDT_WCSR_PRESCALE_1024	(0x5 << WDT_WCSR_PRESCALE_BIT)

#define WDT_WCSR_CLKIN_BIT		0
#define WDT_WCSR_CLKIN_MASK		BITS_H2L(2, WDT_WCSR_CLKIN_BIT)
#define WDT_WCSR_CLKIN_PCK		(0x1 << WDT_WCSR_CLKIN_BIT)
#define WDT_WCSR_CLKIN_RTC		(0x2 << WDT_WCSR_CLKIN_BIT)
#define WDT_WCSR_CLKIN_EXT		(0x4 << WDT_WCSR_CLKIN_BIT)
