...
do {									\
	int timeout = 0x1000;						\
	__wait_write_ready();						\
	OUTREG32(RTC_WENR, (0xa55a));			\
	__wait_write_ready();						\
	while (!(rtc_read_reg(RTC_WENR) & (1<<31)) && timeout--);	\
}while(0);
...
#define CPM_CPSPR	(CPM_BASE+0x34)
#define CPM_CPSPPR  	(CPM_BASE+0x38)
#define CPM_I2SCDR	(CPM_BASE+0x60)
#define CPM_LPCDR	(CPM_BASE+0x64)
#define CPM_MSCCDR	(CPM_BASE+0x68) /* MSC0 and MSC1 device clock divider Register */
...
/* Register Address */
#define UART_RDR	(UART0_BASE + OFF_RDR)
#define UART_TDR	(UART0_BASE + OFF_TDR)
#define UART_DLLR	(UART0_BASE + OFF_DLLR)
#define UART_DLHR	(UART0_BASE + OFF_DLHR)
#define UART_IER	(UART0_BASE + OFF_IER)
#define UART_ISR	(UART0_BASE + OFF_ISR)
#define UART_FCR	(UART0_BASE + OFF_FCR)
#define UART_LCR	(UART0_BASE + OFF_LCR)
#define UART_MCR	(UART0_BASE + OFF_MCR)
#define UART_LSR	(UART0_BASE + OFF_LSR)
#define UART_MSR	(UART0_BASE + OFF_MSR)
#define UART_SPR	(UART0_BASE + OFF_SPR)
#define UART_SIRCR	(UART0_BASE + OFF_SIRCR)
#define UART_UMR	(UART0_BASE + OFF_UMR)
#define UART_UACR	(UART0_BASE + OFF_UACR)

#define REG_UART_RDR	REG8(UART_RDR)
#define REG_UART_TDR	REG8(UART_TDR)
#define REG_UART_DLLR	REG8(UART_DLLR)
#define REG_UART_DLHR	REG8(UART_DLHR)
#define REG_UART_IER	REG8(UART_IER)
#define REG_UART_ISR	REG8(UART_ISR)
#define REG_UART_FCR	REG8(UART_FCR)
#define REG_UART_LCR	REG8(UART_LCR)
#define REG_UART_MCR	REG8(UART_MCR)
#define REG_UART_LSR	REG8(UART_LSR)
#define REG_UART_MSR	REG8(UART_MSR)
#define REG_UART_SPR	REG8(UART_SPR)
#define REG_UART_SIRCR	REG8(UART_SIRCR)
#define REG_UART_UMR	REG8(UART_UMR)
#define REG_UART_UACR	REG8(UART_UACR)
 ...
 */
#define UART_SIRCR_TSIRE	(1 << 0)	/* 0: transmitter is in UART mode  1: IrDA mode */
#define UART_SIRCR_RSIRE	(1 << 1)	/* 0: receiver is in UART mode  1: IrDA mode */
#define UART_SIRCR_TPWS	(1 << 2)	/* 0: transmit 0 pulse width is 3/16 of bit length
					   1: 0 pulse width is 1.6us for 115.2Kbps */
#define UART_SIRCR_TXPL	(1 << 3)	/* 0: encoder generates a positive pulse for 0 */
#define UART_SIRCR_RXPL	(1 << 4)	/* 0: decoder interprets positive pulse as 0 */
...
#define NEMC_SMCR0	(NEMC_BASE + 0x10)  /* Static Memory Control Register 0 */
...
#define NEMC_SACR0	(NEMC_BASE + 0x30)  /* Static Memory Bank 0 Addr Config Reg */
...
#define REG_NEMC_SMCR0	REG32(NEMC_SMCR0)
...
#define REG_NEMC_SACR0	REG32(NEMC_SACR0)
...
#define USB_CNTL1		(USB_BASE + 0x204) /* DMA channel 1 control */
#define USB_ADDR1		(USB_BASE + 0x208) /* DMA channel 1 AHB memory addr */
#define USB_COUNT1		(USB_BASE + 0x20c) /* DMA channel 1 byte count */
#define USB_CNTL2		(USB_BASE + 0x214) /* DMA channel 2 control */
#define USB_ADDR2		(USB_BASE + 0x218) /* DMA channel 2 AHB memory addr */
#define USB_COUNT2		(USB_BASE + 0x21c) /* DMA channel 2 byte count */
