...
#define HW_LCDIF_CTRL__LCD_DATABUS_WIDTH_8_BIT  (1 << 10)
#define HW_LCDIF_CTRL__LCD_DATABUS_WIDTH_18_BIT (2 << 10)
#define HW_LCDIF_CTRL__INPUT_DATA_SWIZZLE_BM    (3 << 14)
#define HW_LCDIF_CTRL__INPUT_DATA_SWIZZLE__NO_SWAP  (0 << 14)
#define HW_LCDIF_CTRL__INPUT_DATA_SWIZZLE__BIG_ENDIAN_SWAP  (1 << 14)
#define HW_LCDIF_CTRL__INPUT_DATA_SWIZZLE__HWD_BYTE_SWAP    (3 << 14)
...
#define HW_LCDIF_DEBUG1         (*(volatile uint32_t *)(HW_LCDIF_BASE + 0x200))
